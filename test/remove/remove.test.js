...
exports.remove = testCase({
    file: function(test) {
        function finished(errors) {
            ...
            test.equals(fs.existsSync(__dirname + "/async/folder/folder1/file2.txt"), false);
            test.done();
        }
    ...
    dir: function(test) {
        function finished(errors) {
            test.strictEqual(errors, null);
            test.equals(fs.existsSync(__dirname + "/async/folder"), false);
            test.done();
        }
    ...
    fileFail: function(test) {
        function finished(errors) {
            ...
            test.equals(unifyPath(errors[0].path), __dirname + "/async/folder/folder1/file2.txt");
            test.done();
        }
    ...
    dirFail: function(test) {
        function finished(errors) {
            test.equals(errors.length, 1);
            test.equals(errors[0].code, "ENOENT");
            test.equals(unifyPath(errors[0].path), __dirname + "/async/folder");
            test.done();
        }
...
exports.removeSync = testCase({
    file: function(test) {
        ...
        test.equals(fs.existsSync(__dirname + "/sync/folder/folder1/file2.txt"), false);
        test.strictEqual(errors, null);
        test.done();        
    },
    dir: function(test) {
        ...
        test.equals(fs.existsSync(__dirname + "/sync/folder"), false);
        test.strictEqual(errors, null);
        test.done();        
    },
    fileFail: function(test) {
        ...
        test.equals(errors.length, 1);
        test.equals(errors[0].code, "ENOENT");
        test.equals(unifyPath(errors[0].path), __dirname + "/sync/folder/folder1/file2.txt");
        test.done();        
    },
    dirFail: function(test) {
        var errors;
        ...
        test.equals(errors.length, 1);
        test.equals(errors[0].code, "ENOENT");
        test.equals(unifyPath(errors[0].path), __dirname + "/sync/folder");
        test.done();        
    }
});